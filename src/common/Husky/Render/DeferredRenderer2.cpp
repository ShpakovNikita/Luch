...
namespace Husky::Render
{
    ...
    bool DeferredRenderer2::Initialize()
    {
...
//        }
    ...
    bool DeferredRenderer2::Deinitialize()
    {
        context.release();
        return true;
    }

    ResultValue<bool, DeferredPreparedScene> DeferredRenderer2::PrepareScene(const RefPtr<SceneV1::Scene>& scene)
    {
    ...
    void DeferredRenderer2::UpdateScene(DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::DrawScene(const DeferredPreparedScene& scene)
    {
...
//        Vector<vk::ClearValue> clearValues = { colorClearValue, depthStencilClearValue };
    ...
    void DeferredRenderer2::PrepareCameraNode(const RefPtr<SceneV1::Node>& node, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::PrepareMeshNode(const RefPtr<SceneV1::Node>& node, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::PrepareLightNode(const RefPtr<SceneV1::Node>& node, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::PrepareNode(const RefPtr<SceneV1::Node>& node, DeferredPreparedScene& scene)
    {
    }

    void DeferredRenderer2::PrepareMesh(const RefPtr<SceneV1::Mesh>& mesh, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::PrepareLight(const RefPtr<SceneV1::Light>& light, DeferredPreparedScene& scene)
    {
        scene.lights.push_back(light);
    }

    void DeferredRenderer2::PrepareMaterial(const RefPtr<SceneV1::PbrMaterial>& material, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::PrepareLights(DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::UpdateNode(const RefPtr<SceneV1::Node>& node, const Mat4x4& parentTransform, DeferredPreparedScene& scene)
    {
        const auto& mesh = node->GetMesh();
...
//        }
    ...
    void DeferredRenderer2::UpdateMesh(const RefPtr<SceneV1::Mesh>& mesh, const Mat4x4& transform, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::UpdateCamera(const RefPtr<SceneV1::Camera>& camera, const Mat4x4& transform, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::UpdateLight(const RefPtr<SceneV1::Light>& light, const Mat4x4& transform, DeferredPreparedScene& scene)
    {
    ...
    void DeferredRenderer2::DrawNode(const RefPtr<SceneV1::Node>& node, const DeferredPreparedScene& scene, GraphicsCommandList* commandList)
    {
        const auto& mesh = node->GetMesh();
        if (mesh != nullptr)
        {
    ...
    void DeferredRenderer2::DrawMesh(const RefPtr<SceneV1::Mesh>& mesh, const DeferredPreparedScene& scene, GraphicsCommandList* commandList)
    {
    ...
    void DeferredRenderer2::DrawPrimitive(const RefPtr<SceneV1::Primitive>& primitive, const DeferredPreparedScene& scene, GraphicsCommandList* commandList)
    {
    ...
    MaterialUniform DeferredRenderer2::GetMaterialUniform(SceneV1::PbrMaterial* material)
    {
    ...
    Vector<Byte> DeferredRenderer2::LoadShaderSource(const FilePath& path)
    {
    ...
    RefPtr<PipelineState> DeferredRenderer2::CreateGBufferPipelineState(const RefPtr<SceneV1::Primitive>& primitive, DeferredPreparedScene& scene)
    {
    ...
    RefPtr<PipelineState> DeferredRenderer2::CreateLightingPipelineState(const LightingPassResources& lighting)
    {
        PipelineStateCreateInfo ci;
    ...
    ResultValue<bool, GBufferPassResources> DeferredRenderer2::PrepareGBufferPassResources(DeferredPreparedScene& scene)
    {
    ...
    ResultValue<bool, LightingPassResources> DeferredRenderer2::PrepareLightingPassResources(DeferredPreparedScene& scene)
    {
    ...
    ResultValue<bool, OffscreenTextures> DeferredRenderer2::CreateOffscreenTextures()
    {
    ...
    ResultValue<bool, RefPtr<ShaderLibrary>> DeferredRenderer2::CreateShaderLibrary(
        const String& path,
